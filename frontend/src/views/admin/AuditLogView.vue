...
<template>
  <div class="audit-page">
    ...
    <div class="filter-bar">
      ...
      <AiButton type="primary" style="height: 40px" @click="loadLogs"> 刷新 </AiButton>
    ...
    >
      ...
      <el-table-column label="操作" width="100">
        <template #default="{ row }">
          <AiButton text type="primary" size="small" @click="openDetail(row)"> 查看详情 </AiButton>
        </template>
      </el-table-column>
    </el-table>
